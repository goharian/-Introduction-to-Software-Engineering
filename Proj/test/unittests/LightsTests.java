...
public class LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by a spot light, a point light and a directional light
     */
    @Test
    public void sphereMultiple() {
        ...
        scene.addLights(new PointLight(new Color(0, 300, 0), new Point3D(50, 50, 0), 1, 0.0000001, 0.00000001),
                new SpotLight(new Color(300, 300, 0), new Point3D(100, -200, -200), new Vector(-1, 1, 1), 1, 0.00001, 0.00000001),
    ...
    public void trianglesMultiple() {
        ...
        scene.addLights(new PointLight(new Color(0, 0, 200), new Point3D(5, 5, 100), 1, 0.000001, 0.0005),
                new SpotLight(new Color(255, 0, 0), new Point3D(10, 0, 130), new Vector(-2, 2, 1), 1, 0.0002, 0.00001),
                new DirectionalLight(new Color(255, 255, 0), new Vector(1, -1, 1))
        );

        ImageWriter imageWriter = new ImageWriter("trianglesMultiple", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
