...
public class ReflectionRefractionTests {
	...
	public void MultiTransparentAndMirror() {
		...
		scene.addGeometries( //
				new Triangle(Color.BLACK, new Material(0.5, 0.5, 60, 0, 0), //
						new Point3D(50, 50, 50), new Point3D(0, 0, 0), new Point3D(100, 20, 150)),
				new Sphere(new Color(java.awt.Color.pink), new Material(0.25, 0.25, 20, 0, 0.5), 50, new Point3D(0, -100, 50)),
				new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.6, 0),
						30, new Point3D(60, -50, 50)),
				new Polygon(new Color(java.awt.Color.RED), new Material(0.3, 0.3, 30, 0.5, 0.5),
						new Point3D(-150, 150, 115), new Point3D(150, 150, 135), new Point3D(200, -50, 156.2121212121212121),
