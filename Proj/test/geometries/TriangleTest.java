...
public class TriangleTest {
    ...
    public void testFindIntersections() {
        ...
        List<Intersectable.GeoPoint> intersects = p1.findIntersections(new Ray(new Point3D(3.5, 2, 1), new Vector(0, 0, 1)));
