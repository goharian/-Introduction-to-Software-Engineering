...
public class PlaneTest {
    ...
    public void testFindIntersections() {
        ...
        List<Point3D> intersect = p1.findIntsersections(new Ray(new Vector(0, 0, 2), new Point3D(0, 2, 1)));
